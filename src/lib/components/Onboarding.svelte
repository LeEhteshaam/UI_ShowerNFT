...
<div class="app-view space-y-6">
  ...
  <div class="space-y-3">
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
      <p class="text-sm text-gray-700">
        <strong>Social Accountability:</strong> When your Proof-of-Lather NFT expires,
        your friends will get an SMS notification. Keep them updated on your hygiene
        status! 🚿📱
      </p>
    </div>
  ...
  <div class="text-xs text-gray-500 text-center">
    <p>
      We use Twilio to send SMS notifications. Standard messaging rates may
      apply.
    </p>
  </div>
</div>
